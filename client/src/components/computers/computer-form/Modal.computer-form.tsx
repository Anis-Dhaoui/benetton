...
function ModalComputerForm(props: PROPSTYPE) {
                        ...
                        <Col md={6}>
                            <FormGroup>
                                ...
                                <input className='form-control'
                                    ...
                                    name="ref"
                                    value={editMode ? targetPC?.ref : undefined}
                                />
                            </FormGroup>
                        </Col>
                        <Col md={6}>
                            <FormGroup>
                                ...
                                <select className='form-select'
                                    ...
                                    name="brandName"
                                    value={editMode ? targetPC?.brandName : undefined}
                                >
                        ...
                        <Col md={6}>
                            <FormGroup>
                                ...
                                <input className='form-control'
                                    ...
                                    name="model"
                                    value={editMode ? targetPC?.model : undefined}
                                />
                            </FormGroup>
                        </Col>
                        <Col md={6}>
                            <FormGroup>
                                ...
                                <select className='form-select'
                                    ...
                                    name="os"
                                    value={editMode ? targetPC?.os : undefined}
                        ...
                        <Col md={6}>
                            <FormGroup>
                                ...
                                <input className='form-control'
                                    ...
                                    value={editMode ? targetPC?.cpu : undefined}
                                    name="cpu"
                                />
                            </FormGroup>
                        </Col>
                        <Col md={6}>
                            <FormGroup>
                                ...
                                <select className='form-select'
                                    ...
                                    value={editMode ? targetPC?.status : undefined}
                                    name="status"
                                >
                                ...
                                <Col md={4}>
                                    <FormGroup>
                                        ...
                                        <input className='form-control'
                                            ...
                                            value={editMode ? targetPC?.usedBy.split(" / ")[0] : undefined}
                                            name="usedBy"
                                        />
                                    </FormGroup>
                                </Col>
                                <Col md={8} style={{ marginTop: '31px' }}>
                                    <FormGroup>
                                        <input className='form-control'
                                            ...
                                            value={editMode ? targetPC?.usedBy.split(" / ")[1] : undefined}
                                            name="usedByFullname"
                                        />
                                    </FormGroup>
                                </Col>
                        ...
                        <Col md={6}>
                            <FormGroup>
                                ...
                                <select className='form-select'
                                    ...
                                    value={editMode ? targetPC?.type : undefined}
                                    name="type"
                                >
                        ...
                        <Col md={6}>
                            <FormGroup>
                                ...
                                <select className='form-select'
                                    ...
                                    name="group"
                                    value={editMode ? targetPC?.group : undefined}
                                >
...
export default ModalComputerForm